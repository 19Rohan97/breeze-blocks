...
class Element_Post_Content extends Element {
	...
	public function render() {
		...
		// STEP: Render WordPress content
			...
			// Load current $post_id context while preserving Gutenberg preview autosaves
			// (#86c9wy4u5; @since 2.3.6).
			$post = Helpers::get_post_preserving_preview( $this->post_id );
			...
			if ( intval( apply_filters( 'bricks/content_analysis/full_post_content_id', 0 ) ) === intval( $this->post_id ) ) {
