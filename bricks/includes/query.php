...
class Query {
	...
	public function __construct( $element = [] ) {
		 ...
		 *
		 * Direct slot component instances keep their local ID because their slotChildren map is
		 * stored on that local instance, not on the outer component instance.
