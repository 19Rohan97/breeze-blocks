...
class I18n {
	public static function get_frontend_i18n() {
		return [
			'choicesjs'        => [
				'noChoicesText'      => __( 'No choices to choose from', 'bricks' ),
				'noResultsText'      => __( 'No results found', 'bricks' ),
	...
	public static function get_builder_i18n() {
		return [
			...
			'insertSameComponentError'                    => __( 'This component can\'t be inserted here because it would create a circular component reference and break rendering.', 'bricks' ),
			...
			// Info text for unsupported mixed component selections. (#86ca5mqxw; @since 2.3.7)
			'mixedComponentSelectionInfo'                 => __( 'Controls cannot be displayed for this mixed selection.', 'bricks' ),
			...
			'scaleGenerateVariablesDuplicateConfirm'      => __( 'Some generated variable names already exist. Do you want to proceed?', 'bricks' ),
